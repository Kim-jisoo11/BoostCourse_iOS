...
//
//    button.addTarget(self, action: #selector(self.playPauseButton(_:)), for: UIControl.Event.touchUpInside)
//
...
//
//    slider.addTarget(self, action: #selector(self.progressSlider(_:)), for: UIControl.Event.valueChanged)
//
